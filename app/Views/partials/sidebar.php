    ...
    <div class="sidebar">
        ...
        <div class="sidebar-section">
            ...
            <div class="sidebar-list" id="topAnimeList">
                <div id="topAnimeListToday">
                    <?php if (!empty($trendingAnimeToday)): ?>
                        <?php foreach ($trendingAnimeToday as $index => $anime): ?>
                ...
                <div id="topAnimeListWeek" style="display:none;">
                    <?php if (!empty($trendingAnimeWeek)): ?>
                        <?php foreach ($trendingAnimeWeek as $index => $anime): ?>
                            <a href="<?= base_url('watch/' . createSlug($anime['title'])) ?>" class="sidebar-item recommended" style="text-decoration: none; color: inherit;">
                                <div class="item-thumbnail">
                                    <img src="<?= !empty($anime['backgroundImage']) ? esc($anime['backgroundImage']) : 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=50&h=70&fit=crop' ?>" alt="<?= esc($anime['title']) ?>">
                                </div>
                ...
                <div id="topAnimeListMonth" style="display:none;">
                    <?php if (!empty($trendingAnimeMonth)): ?>
                        <?php foreach ($trendingAnimeMonth as $index => $anime): ?>
                            <a href="<?= base_url('watch/' . createSlug($anime['title'])) ?>" class="sidebar-item recommended" style="text-decoration: none; color: inherit;">
                                <div class="item-thumbnail">
                                    <img src="<?= !empty($anime['backgroundImage']) ? esc($anime['backgroundImage']) : 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=50&h=70&fit=crop' ?>" alt="<?= esc($anime['title']) ?>">
                                </div>
