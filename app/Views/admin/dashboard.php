                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea class="form-control admin-form-control" id="notification_message" name="notification_message" rows="8" placeholder="Enter your notification message..." required maxlength="4000"></textarea>
                                                        <div class="form-text">
                                                            <small class="admin-text-muted">Maximum 4000 characters. <span id="message_count">0</span>/4000</small>
